...
import firebase_admin                        #Para la base de datos
...
firebase_sdk = credentials.Certificate('bot-telegram-d153a-firebase-adminsdk-gmoyr-22c38948a7.json')
firebase_admin.initialize_app(firebase_sdk, {'databaseURL': 'https://bot-telegram-d153a-default-rtdb.europe-west1.firebasedatabase.app/'})
print("Conectando base de datos")
ref = db.reference('/usernames')
ref.push({'id':'2', 'name':'@CarloaPlox'})
